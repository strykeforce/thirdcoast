...
class DCommandTest extends AbstractTalonConfigCommandTest {

    Command command

    @Override
    void setup() {
        command = new DCommand(reader, talonSet)
    }
    ...
    def "handles input"() {
        ...
        1 * talon.config_kD(0, 27.67, AbstractDoubleConfigCommand.TIMEOUT_MS) // 27.67
