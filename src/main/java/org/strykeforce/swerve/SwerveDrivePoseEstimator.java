 ...
 */
public class SwerveDrivePoseEstimator implements Measurable  {
  ...
  private String typeName = "PoseEstimator";
  private String description = "PoseEstimator";
  private Pose2d poseGraph = new Pose2d();
  private Pose2d resetPoseGraph = new Pose2d();
  private double visionTimeStampGrapher = 0.0;
  ...
  public void addVisionMeasurement(Pose2d visionRobotPoseMeters, double timestampSeconds) {
    ...
    visionTimeStampGrapher = timestampSeconds;
    if (sample.isEmpty()) {
      return;
    }
    ...
    poseGraph = sample.get().poseMeters;
    ...
    resetPoseGraph = m_odometry.getPoseMeters();
  ...
  @Override
    public Set<Measure> getMeasures() {
        return Set.of(new Measure("Interprolated x", () -> poseGraph.getX()), 
        new Measure("Interprolated y", () -> poseGraph.getY()), 
        new Measure("Timestamp Interp", () -> visionTimeStampGrapher), 
        new Measure("Reset Pose X", () -> resetPoseGraph.getX()),
        new Measure("Reset Pose Y", () -> resetPoseGraph.getY()));
    }
}
