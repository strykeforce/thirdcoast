...
/**
 * A class that has one or more [Measurable] objects that should be registered with the
 * [TelemetryService].
 */
interface Registrable {
   ...
   *
   * This method should be called once during robot initialization before the [TelemetryService] is
   * started.
   *
