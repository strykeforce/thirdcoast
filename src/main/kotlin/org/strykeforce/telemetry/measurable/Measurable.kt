...
/**
 * An item that can be measured and graphed. These are used as `Set` elements and implementing
 * classes should implement an identity-based version of equals and hashCode.
 *
 * The abstract base class implementing `Measurable` implements `Comparable` by comparing the
 * results returned by `Measurable#deviceId()`.
 */
