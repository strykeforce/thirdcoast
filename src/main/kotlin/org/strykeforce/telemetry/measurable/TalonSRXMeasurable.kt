...
constructor(
  ...
  override val measures =
    setOf(
      Measure(CLOSED_LOOP_TARGET, "Closed-loop Setpoint (PID 0)") { talon.getClosedLoopTarget(0) },
      Measure(STATOR_CURRENT, "Stator Current") { talon.statorCurrent },
      Measure(SUPPLY_CURRENT, "Supply Current") { talon.supplyCurrent },
      ...
      Measure(CLOSED_LOOP_ERROR, "Closed Loop Error (PID 0)") { talon.getClosedLoopError(0) },
      ...
      Measure(QUAD_IDX_PIN, "Quad Index Pin State") { sensorCollection.pinStateQuadIdx.toDouble() },
