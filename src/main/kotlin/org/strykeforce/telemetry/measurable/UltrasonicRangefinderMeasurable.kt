...
/**
 * Represents a PWM ultrasonic rangefinder telemetry-enable `Measurable` item connected to a
 * `CANifier`.
 */
class UltrasonicRangefinderMeasurable
@JvmOverloads
constructor(
  canId: Int,
