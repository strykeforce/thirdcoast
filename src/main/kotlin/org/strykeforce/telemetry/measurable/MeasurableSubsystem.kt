 ...
 * <code><pre>
 *
 * @Override public Set<Measure> getMeasures() { return Set.of( new Measure("Gyro Rotation2d (deg)",
 *   () -> swerveDrive.getHeading().getDegrees()), new Measure("Gyro Angle (deg)",
 *   swerveDrive::getGyroAngle), new Measure("Odometry X", () ->
 *   swerveDrive.getPoseMeters().getX()), new Measure("Odometry Y", () ->
 *   swerveDrive.getPoseMeters().getY()), ); }</pre></code>
 *
 ...
 * <code><pre>
 *
 * @Override public void registerWith(TelemetryService: telemetryService) {
 *   super.registerWith(telemetryService); telemetryService.register(talon); }</pre></code>
 */
